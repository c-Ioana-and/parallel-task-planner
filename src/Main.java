...
public class Main {
    ...
    private static int runTest(Test test) {
        ...
        String curentDir = System.getProperty("user.dir") + File.separator + "checker";
        File[] dir = new File(curentDir + File.separator + "in" + File.separator + test.inFolder).listFiles();
        if (dir != null) {
            for (File input : dir) {
...
//            String output = new Scanner(new File("in" + File.separator + test.inFolder + File.separator + "out")).useDelimiter("\\Z").next();
            String output = new Scanner(new File(curentDir + File.separator + "in" + File.separator + test.inFolder + File.separator + "out")).useDelimiter("\\Z").next();
